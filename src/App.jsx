...
const getActivities = () => {
  return {
    transport: [
      { id: 'car_10k', name: 'Coche (10km)', co2: 1.4, scoreImpact: -15, icon: '🚗', baseUnit: '10 km' },
      { id: 'bus_10k', name: 'Autobús (10km)', co2: 0.8, savedCo2: 0.6, scoreImpact: +10, icon: '🚌', baseUnit: '10 km' },
      { id: 'bike_10k', name: 'Bici (10km)', co2: 0, savedCo2: 1.4, scoreImpact: +25, icon: '🚲', baseUnit: '10 km' },
      { id: 'train_50k', name: 'Tren (50km)', co2: 1.2, savedCo2: 5.8, scoreImpact: +15, icon: '🚆', baseUnit: '50 km' },
      { id: 'flight_short', name: 'Vuelo corto', co2: 120, scoreImpact: -120, icon: '✈️', baseUnit: '1 vuelo' },
      { id: 'flight_long', name: 'Vuelo largo', co2: 650, scoreImpact: -600, icon: '🌎', baseUnit: '1 vuelo' },
    ],
    food: [
      { id: 'beef_steak', name: 'Ternera (250g)', co2: 6.75, scoreImpact: -68, icon: '🥩', baseUnit: '250g' },
      { id: 'pork_chop', name: 'Cerdo (250g)', co2: 2.1, scoreImpact: -20, icon: '🍖', baseUnit: '250g' },
      { id: 'chicken_breast', name: 'Pollo (250g)', co2: 1.4, scoreImpact: -14, icon: '🍗', baseUnit: '250g' },
      { id: 'coffee_milk', name: 'Café con Leche', co2: 0.55, scoreImpact: -5, icon: '☕', baseUnit: '1 taza' },
      { id: 'coffee_oat', name: 'Café Avena', co2: 0.18, savedCo2: 0.37, scoreImpact: +5, icon: '🌾', baseUnit: '1 taza' },
      { id: 'avocado', name: 'Aguacate (1 ud)', co2: 0.2, scoreImpact: -2, icon: '🥑', baseUnit: '1 ud' },
      { id: 'beer', name: 'Cerveza (caña)', co2: 0.45, scoreImpact: -4, icon: '🍺', baseUnit: '330ml' },
    ],
    energy: [
      { id: 'heater_1h', name: 'Calefacción (1h)', co2: 1.1, scoreImpact: -10, icon: '🔥', baseUnit: '1 hora' },
      { id: 'cold_wash', name: 'Lavadora Fría', co2: 0.25, savedCo2: 0.45, scoreImpact: +5, icon: '👕', baseUnit: '1 uso' },
      { id: 'hot_wash', name: 'Lavadora 60º', co2: 0.9, scoreImpact: -10, icon: '👔', baseUnit: '1 uso' },
      { id: 'dishwasher', name: 'Lavavajillas', co2: 0.7, scoreImpact: -7, icon: '🍽️', baseUnit: '1 ciclo' },
      { id: 'laptop_8h', name: 'Laptop (8h)', co2: 0.3, scoreImpact: -3, icon: '💻', baseUnit: '8 horas' },
    ],
    shopping: [
      { id: 'tshirt_cotton', name: 'Camiseta Algodón', co2: 4.3, scoreImpact: -40, icon: '👕', baseUnit: '1 ud' },
      { id: 'jeans', name: 'Pantalones Vaqueros', co2: 33.4, scoreImpact: -200, icon: '👖', baseUnit: '1 ud' },
      { id: 'smartphone', name: 'Móvil Nuevo', co2: 80, scoreImpact: -500, icon: '📱', baseUnit: 'Producción' },
      { id: 'plastic_bag', name: 'Bolsa Plástico', co2: 1.5, scoreImpact: -15, icon: '🛍️', baseUnit: '1 ud' },
    ],
    lifestyle: [
      { id: 'recycle_plastic', name: 'Reciclar Plástico', co2: 0, savedCo2: 1.5, scoreImpact: +20, icon: '♻️', baseUnit: '1 kg' },
      { id: 'plant_tree', name: 'Plantar Árbol', co2: -10.0, savedCo2: 10.0, scoreImpact: +100, icon: '🌳', baseUnit: '1 año' },
    ]
  };
};
...
export default function App() {
  ...
  const handleAdd = (act) => {
    ...
    setUserProfile({ ...userProfile, score: newScore, history: newHistory });
    setQuantity(1);
  };
  ...
  const mockLeaderboard = [
    ...
    { id: '3', name: 'Laura_Málaga', score: 420 },
  ];
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-800 pb-40 selection:bg-emerald-100">
      ...
      <div className="max-w-3xl mx-auto p-4 space-y-6">
        <header className="relative flex flex-col items-center gap-4 pt-4">
          ...
          <RetroPixelScreen score={userProfile.score} />
        </header>
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-xl relative overflow-hidden">
                ...
                <p className="text-[12px] mt-4 font-bold text-slate-300 h-10 transition-all italic leading-tight">
                   {dailyStats.gen > 0 ? ACTION_TIPS[equivIndex](dailyStats.gen) : t.dayClean}
                </p>
              </div>
              <div className="bg-emerald-500 text-white p-6 rounded-3xl shadow-xl shadow-emerald-200 relative overflow-hidden">
                ...
                <p className="text-[12px] mt-4 font-bold text-white h-10 transition-all italic leading-tight">
                   {dailyStats.saved > 0 ? "¡El planeta respira mejor! 🌍" : t.addGreen}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-8">
              ...
              <div className="pt-8 border-t border-slate-100 space-y-5">
                ...
                <form onSubmit={searchLocal} className="relative flex gap-3">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-slate-900 text-white p-10 rounded-[3rem] space-y-8 shadow-2xl relative overflow-hidden">
               ...
               <div className="space-y-4 relative z-10">
                 {mockLeaderboard.sort((a, b) => b.score - a.score).map((p, i) => (
                   <div key={p.id} className={`flex justify-between items-center p-6 rounded-[2rem] transition-all ${p.id==='2'?'bg-emerald-500 shadow-xl shadow-emerald-500/40 scale-105':'bg-white/5 hover:bg-white/10'}`}>
